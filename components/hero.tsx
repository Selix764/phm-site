...
export function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative pt-[120px] pb-[80px] px-5 md:px-[120px] max-w-[1400px] mx-auto overflow-hidden"
    >
      ...
      <div className="relative z-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <h1 className="font-bold text-[42px] md:text-[56px] leading-[1.1] text-white mb-6">
            <span className="block">We brand your</span>
            <span className="text-[#FF0000]">lifestyle</span>
          </h1>

          <p className="text-[18px] text-white/80 mb-8 max-w-[600px]">
            Suntem o platformă şi un canal de comunicare cu experienţă în producţia de media şi lifestyle, ce oferă
            soluţii creative pentru susţinerea succesului oricărei afaceri din orice domeniu.
          </p>
